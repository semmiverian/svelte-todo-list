        ...
        {#each todoList as todo, index}
          <div
            ...
            {#if index === updateTodoIndex}
              <input
                class="bg-gray-100 focus:bg-white focus:border-gray-200 border
                p-2 flex-grow rounded appearance-none focus:outline-none mr-2"
            ...
            <div class="flex flex-row">
              ...
              <svg
                ...
                <path
                  class="primary"
                  d="M5 5h14l-.89 15.12a2 2 0 0 1-2 1.88H7.9a2 2 0 0 1-2-1.88L5
                  5zm5 5a1 1 0 0 0-1 1v6a1 1 0 0 0 2 0v-6a1 1 0 0 0-1-1zm4 0a1 1
                  0 0 0-1 1v6a1 1 0 0 0 2 0v-6a1 1 0 0 0-1-1z" />
                <path
                  class="secondary"
          ...
          <div class="flex flex-row">
            ...
            <svg
              ...
              <path
                class="primary"
                d="M5 5h14l-.89 15.12a2 2 0 0 1-2 1.88H7.9a2 2 0 0 1-2-1.88L5
                5zm5 5a1 1 0 0 0-1 1v6a1 1 0 0 0 2 0v-6a1 1 0 0 0-1-1zm4 0a1 1 0
                0 0-1 1v6a1 1 0 0 0 2 0v-6a1 1 0 0 0-1-1z" />
              <path
                class="secondary"
                d="M8.59 4l1.7-1.7A1 1 0 0 1 11 2h2a1 1 0 0 1 .7.3L15.42 4H19a1
                1 0 0 1 0 2H5a1 1 0 1 1 0-2h3.59z" />
            </svg>
          </div>
        </div> -->
      </div>
